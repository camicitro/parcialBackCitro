...
public interface PersonaRepository extends BaseRepository<Persona, Long> {
    ...
    //anotacion del METODO DE QUERY
    List<Persona> findByNombreContainingOrApellidoContaining(String nombre, String apellido);   //no son tan usados estos

    //ver si existe o no una persona:
    //boolean existByDni(int dni);

    //anotacion de JPQL usando parametros indexados
